                  ...
                  <table id="order-listing" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
           <a href="{{ URL::to('/studentView',$view_student->student_id) }}"><button class="btn btn-outline-primary sm-2">View</button></a>
           <a href="{{ URL::to('/studentEdit',$view_student->student_id) }}">
            <button class="btn btn-outline-warning sm-2">edit</button>
          </a>

            <a  href="{{ URL::to('student_delete',$view_student->student_id)}} ">
